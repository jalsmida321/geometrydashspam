...
import { Gamepad2, TrendingUp, BookOpen, Shield } from 'lucide-react';
import { Wave, Unlock } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex">
            ...
            <Link to="/trending" className="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
              ...
              Trending
            </Link><Link to="/space-waves" className="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
  <Wave className="mr-1.5 h-5 w-5" />
  Space Waves Challenge
</Link>
<Link to="/geometry-dash-unblocked" className="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
...
<Link to="/space-waves" className="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
  <Wave className="mr-1.5 h-5 w-5" />
  Space Waves Challenge
</Link>
<Link to="/geometry-dash-unblocked" className="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
